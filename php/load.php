...
$manticore->query("CREATE TABLE IF NOT EXISTS rt(title text, body text, url text stored) html_strip='1' index_exact_words='1' morphology='lemmatize_en_all' index_sp='1'"); /* creating a table "rt" if it doesn't exist with the following settings:

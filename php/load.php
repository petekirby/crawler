...
$manticore->query("CREATE TABLE IF NOT EXISTS rt(title text, body text, url text stored) index_exact_words='1'"); /* creating a table "rt" if it doesn't exist with the following settings:

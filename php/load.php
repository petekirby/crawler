...
$manticore->query("CREATE TABLE IF NOT EXISTS rt(title text, body text, url text stored) index_exact_words='1' expand_keywords='1' min_prefix_len='4' index_sp='1'"); /* creating a table "rt" if it doesn't exist with the following settings:
